...
export default function Characteristics({ type }) {
  const {
    transmission,
    engine,
    AC,
  ...
  //   const transmission = useSelector(selectorTransmission);
  //   const engine = useSelector(selectorEngine);
  ...
  //   const radio = useSelector(selectorRadio);
  //   const refrigerator = useSelector(selectorRefrigerator);
  //   const microwave = useSelector(selectorMicrowave);
  //   const gas = useSelector(selectorGas);
  //   const water = useSelector(selectorWater);
